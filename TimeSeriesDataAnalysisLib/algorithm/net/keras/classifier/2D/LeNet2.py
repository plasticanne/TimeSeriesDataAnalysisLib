...
def get_model(inputCNNshape,nb_classes):
    ...
    inputNorm = L.BatchNormalization()(inputCNN)
...
#     pool = MaxPooling2D(pool_size=(3,3),strides=(2,2),padding='same')(x)
    ...
    conv = L.Convolution2D(32, 3, 3, border_mode='same', activation='relu')(inputNorm)
...
#     pool = Dropout(0.25)(pool)
    ...
    conv = L.Convolution2D(32, 3, 3, border_mode='same', activation='relu')(pool)
...
#     pool = Dropout(0.25)(pool)
    ...
    conv = L.Convolution2D(64, 3, 3, border_mode='same', activation='relu')(pool)
...
#     pool = Dropout(0.25)(pool)
    ...
    conv = L.Convolution2D(128, 3, 3, border_mode='same', activation='relu')(pool)
